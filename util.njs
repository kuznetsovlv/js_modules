...
exports.ratesByAge = function ratesByAge (obj) {
	var res = [];
	for (var key in obj) {
		if (isNumeric(key))
...
function toObj (keys, values, delimeter) {
...
exports.readConfig = function readConfig (path, delimeter, encoding) {
...
exports.selectMin = function selectMin (arr, key) {
...
exports.saveSuccess = function saveSuccess (o) {
